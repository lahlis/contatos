    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `account` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT NOT NULL, `phone` TEXT NOT NULL, `email` TEXT NOT NULL, `image_path` TEXT NOT NULL)');
...
class _$AccountDao extends AccountDao {
  ...
  @override
  Future<List<AccountEntity>> fetchAllAccount() async {
